...
```sh
  git clone https://github.com/Elhambasir/bookstore-add-reducers-and-actions.git
  cd bookstore-add-reducers-and-actions
```
...
Feel free to check the [https://github.com/Elhambasir/bookstore-add-reducers-and-actions/issues](issue page).
